...
const staticRoutes: {
  ...
  {
    path: "/investors/investment-opportunity",
  ...
  { path: "/network/apply", changeFrequency: "monthly", priority: 0.7 },
  { path: "/network/access", changeFrequency: "monthly", priority: 0.7 },
  { path: "/services", changeFrequency: "monthly", priority: 0.8 },
  { path: "/how-to-buy", changeFrequency: "monthly", priority: 0.9 },
  { path: "/guides", changeFrequency: "monthly", priority: 0.8 },
  { path: "/guides/cif-dubai-real-vs-scam", changeFrequency: "monthly", priority: 0.7 },
  { path: "/guides/buy-gold-uganda-refinery", changeFrequency: "monthly", priority: 0.7 },
  { path: "/guides/linkedin-gold-scams", changeFrequency: "monthly", priority: 0.7 },
